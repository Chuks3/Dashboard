...
const Route = ({
    ...
    return <button className={`flex items-center justif-start gap-2 w-full rounded px-2 py-1.5 text-sm transition-[box-shadow,_background-color,_color] ${selected ? "bg-white text-stone-950 shadow" : "hovering:bg-stone-200 bg-transparent text-stone-500 shadow-none"}`}>
